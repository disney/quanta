...
// atw FIXME:
func XXTestFuncResolver(t *testing.T) {
	t.Parallel()
...
// atw FIXME:
func XXTestFilterErrMsg(t *testing.T) {
	t.Parallel()
...
// atw FIXME:
func XXTestFilterNewLines(t *testing.T) {
	t.Parallel()
...
func XXTestFilterQlRoundTrip(t *testing.T) {
	t.Parallel()
...
func XXTestFilterQlFingerPrint(t *testing.T) {
	t.Parallel()
...
func XXTestFilterSelectParse(t *testing.T) {
	t.Parallel()
...
func XXTestFilterQLAstCheck(t *testing.T) {
	t.Parallel()
	ql := `
		FILTER 
			AND (
