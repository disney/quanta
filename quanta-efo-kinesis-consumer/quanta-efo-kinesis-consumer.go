...
import (
	...
	q_efo_kinesis_lib "github.com/disney/quanta/quanta-efo-kinesis-consumer-lib"
...
func main() {
	...
	shared.InitLogging(*logLevel, *environment, q_efo_kinesis_lib.AppName, Version, "Quanta")

	builtins.LoadAllBuiltins()
	functions.LoadAll()

	main := q_efo_kinesis_lib.NewMain()
	main.Stream = *stream
	main.Region = *region
	main.Schema = *schema
